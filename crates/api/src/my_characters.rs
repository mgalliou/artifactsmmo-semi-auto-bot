...
impl MyCharacterApi {
    ...
    pub fn r#move(
        ...
        crate::runtime().block_on(action_move_my_name_action_move_post(
            &self.configuration,
            name,
            dest,
        ))
    ...
    > {
        crate::runtime().block_on(action_transition_my_name_action_transition_post(
            &self.configuration,
            name,
        ))
    }
    ...
    pub fn fight(
        ...
        crate::runtime().block_on(action_fight_my_name_action_fight_post(
            &self.configuration,
            name,
            Some(schema),
        ))
    ...
    pub fn rest(
        ...
        crate::runtime().block_on(action_rest_my_name_action_rest_post(
            &self.configuration,
            name,
        ))
    }
    ...
    pub fn gather(
        ...
        crate::runtime().block_on(action_gathering_my_name_action_gathering_post(
            &self.configuration,
            name,
        ))
    }
    ...
    pub fn craft(
        ...
        crate::runtime().block_on(action_crafting_my_name_action_crafting_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    pub fn recycle(
        ...
        crate::runtime().block_on(action_recycling_my_name_action_recycling_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    pub fn delete(
        ...
        crate::runtime().block_on(action_delete_item_my_name_action_delete_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    pub fn equip(
        ...
        crate::runtime().block_on(action_equip_item_my_name_action_equip_post(
            &self.configuration,
            name,
            vec![schema],
        ))
    ...
    pub fn unequip(
        ...
        schema.quantity = quantity;
        crate::runtime().block_on(action_unequip_item_my_name_action_unequip_post(
            &self.configuration,
            name,
            vec![schema],
        ))
    ...
    pub fn use_item(
        ...
        crate::runtime().block_on(action_use_item_my_name_action_use_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    pub fn accept_task(
        ...
        crate::runtime().block_on(action_accept_new_task_my_name_action_task_new_post(
            &self.configuration,
            name,
        ))
    }
    ...
    {
        crate::runtime().block_on(action_task_cancel_my_name_action_task_cancel_post(
            &self.configuration,
            name,
        ))
    }
    ...
    {
        crate::runtime().block_on(action_complete_task_my_name_action_task_complete_post(
            &self.configuration,
            name,
        ))
    }
    ...
    {
        crate::runtime().block_on(action_task_exchange_my_name_action_task_exchange_post(
            &self.configuration,
            name,
        ))
    }
    ...
    > {
        ...
        crate::runtime().block_on(action_npc_buy_item_my_name_action_npc_buy_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    > {
        let schema = NpcMerchantBuySchema::new(code, quantity);
        crate::runtime().block_on(action_npc_sell_item_my_name_action_npc_sell_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    pub fn give_item(
        ...
        crate::runtime().block_on(action_give_items_my_name_action_give_item_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    pub fn give_gold(
        ...
        crate::runtime().block_on(action_give_gold_my_name_action_give_gold_post(
            &self.configuration,
            name,
            schema,
        ))
    ...
    > {
        ...
        crate::runtime().block_on(action_ge_buy_item_my_name_action_grandexchange_buy_post(
            &self.configuration,
            name,
            schema,
        ))
