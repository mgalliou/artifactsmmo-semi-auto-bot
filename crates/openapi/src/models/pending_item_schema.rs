...
impl PendingItemSchema {
    ...
    pub fn new(id: String, account: String, source: models::PendingItemSource, description: String, created_at: chrono::DateTime<chrono::FixedOffset>) -> PendingItemSchema {
        PendingItemSchema {
            id,
            account,
            source,
