...
impl StatusSchema {
    pub fn new(version: String, server_time: chrono::DateTime<chrono::FixedOffset>, max_level: i32, max_skill_level: i32, characters_online: i32, rate_limits: Vec<models::RateLimitSchema>) -> StatusSchema {
        StatusSchema {
            version,
            server_time,
            max_level,
