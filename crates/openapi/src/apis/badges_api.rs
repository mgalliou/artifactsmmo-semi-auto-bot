...
/// List of all badges.
pub fn get_all_badges_badges_get(configuration: &configuration::Configuration, page: Option<u32>, size: Option<u32>) -> Result<models::StaticDataPageBadgeSchema, Error<GetAllBadgesBadgesGetError>> {
