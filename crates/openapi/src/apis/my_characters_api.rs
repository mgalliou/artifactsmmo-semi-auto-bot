...
pub fn action_ge_create_buy_order_my_name_action_grandexchange_create_buy_order_post(configuration: &configuration::Configuration, name: &str, ge_buy_order_creation_schema: models::GeBuyOrderCreationSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateBuyOrderMyNameActionGrandexchangeCreateBuyOrderPostError>> {
    ...
    let uri_str = format!("{}/my/{name}/action/grandexchange/create-buy-order", configuration.base_path, name=crate::apis::urlencode(p_path_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub fn action_ge_create_sell_order_my_name_action_grandexchange_create_sell_order_post(configuration: &configuration::Configuration, name: &str, ge_order_creationr_schema: models::GeOrderCreationrSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateSellOrderMyNameActionGrandexchangeCreateSellOrderPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_ge_order_creationr_schema = ge_order_creationr_schema;

    let uri_str = format!("{}/my/{name}/action/grandexchange/create-sell-order", configuration.base_path, name=crate::apis::urlencode(p_path_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
