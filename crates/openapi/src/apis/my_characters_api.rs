...
pub fn action_claim_pending_item_my_name_action_claim_item_id_post(configuration: &configuration::Configuration, name: &str, id: &str) -> Result<models::ClaimPendingItemResponseSchema, Error<ActionClaimPendingItemMyNameActionClaimItemIdPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_path_id = id;
...
pub fn action_equip_item_my_name_action_equip_post(configuration: &configuration::Configuration, name: &str, equip_schema: Vec<models::EquipSchema>) -> Result<models::EquipmentResponseSchema, Error<ActionEquipItemMyNameActionEquipPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub fn action_ge_cancel_order_my_name_action_grandexchange_cancel_post(configuration: &configuration::Configuration, name: &str, ge_cancel_order_schema: models::GeCancelOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeCancelOrderMyNameActionGrandexchangeCancelPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub fn action_ge_create_buy_order_my_name_action_grandexchange_create_buy_order_post(configuration: &configuration::Configuration, name: &str, ge_buy_order_creation_schema: models::GeBuyOrderCreationSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateBuyOrderMyNameActionGrandexchangeCreateBuyOrderPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub fn action_ge_create_sell_order_my_name_action_grandexchange_create_sell_order_post(configuration: &configuration::Configuration, name: &str, ge_order_creation_schema: models::GeOrderCreationSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateSellOrderMyNameActionGrandexchangeCreateSellOrderPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub fn action_ge_fill_my_name_action_grandexchange_fill_post(configuration: &configuration::Configuration, name: &str, ge_fill_buy_order_schema: models::GeFillBuyOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeFillMyNameActionGrandexchangeFillPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub fn action_unequip_item_my_name_action_unequip_post(configuration: &configuration::Configuration, name: &str, unequip_schema: Vec<models::UnequipSchema>) -> Result<models::EquipmentResponseSchema, Error<ActionUnequipItemMyNameActionUnequipPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
