...
/// struct for typed errors of method [`action_claim_pending_item_my_name_action_claim_item_id_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionClaimPendingItemMyNameActionClaimItemIdPostError {
    Status404(models::ErrorResponseSchema),
    Status498(models::ErrorResponseSchema),
...
/// struct for typed errors of method [`action_ge_cancel_order_my_name_action_grandexchange_cancel_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionGeCancelOrderMyNameActionGrandexchangeCancelPostError {
    Status598(models::ErrorResponseSchema),
    Status498(models::ErrorResponseSchema),
    Status497(models::ErrorResponseSchema),
    Status499(models::ErrorResponseSchema),
...
/// struct for typed errors of method [`action_ge_create_buy_order_my_name_action_grandexchange_create_buy_order_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionGeCreateBuyOrderMyNameActionGrandexchangeCreateBuyOrderPostError {
    Status498(models::ErrorResponseSchema),
    Status499(models::ErrorResponseSchema),
    Status486(models::ErrorResponseSchema),
    Status404(models::ErrorResponseSchema),
...
/// struct for typed errors of method [`action_ge_create_sell_order_my_name_action_grandexchange_create_sell_order_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionGeCreateSellOrderMyNameActionGrandexchangeCreateSellOrderPostError {
    Status498(models::ErrorResponseSchema),
    Status499(models::ErrorResponseSchema),
    Status486(models::ErrorResponseSchema),
    Status404(models::ErrorResponseSchema),
...
/// struct for typed errors of method [`action_ge_fill_my_name_action_grandexchange_fill_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionGeFillMyNameActionGrandexchangeFillPostError {
    Status598(models::ErrorResponseSchema),
    Status498(models::ErrorResponseSchema),
    Status499(models::ErrorResponseSchema),
    Status436(models::ErrorResponseSchema),
...
/// struct for typed errors of method [`action_rename_my_name_action_rename_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActionRenameMyNameActionRenamePostError {
...
pub async fn action_buy_bank_expansion_my_name_action_bank_buy_expansion_post(configuration: &configuration::Configuration, name: &str) -> Result<models::BankExtensionTransactionResponseSchema, Error<ActionBuyBankExpansionMyNameActionBankBuyExpansionPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_change_skin_my_name_action_change_skin_post(configuration: &configuration::Configuration, name: &str, change_skin_character_schema: models::ChangeSkinCharacterSchema) -> Result<models::ChangeSkinResponseSchema, Error<ActionChangeSkinMyNameActionChangeSkinPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_claim_pending_item_my_name_action_claim_item_id_post(configuration: &configuration::Configuration, name: &str, id: &str) -> Result<models::ClaimPendingItemResponseSchema, Error<ActionClaimPendingItemMyNameActionClaimItemIdPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_path_id = id;

    let uri_str = format!("{}/my/{name}/action/claim_item/{id}", configuration.base_path, name=crate::apis::urlencode(p_path_name), id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ClaimPendingItemResponseSchema`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ClaimPendingItemResponseSchema`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActionClaimPendingItemMyNameActionClaimItemIdPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Complete a task.
pub async fn action_complete_task_my_name_action_task_complete_post(configuration: &configuration::Configuration, name: &str) -> Result<models::RewardDataResponseSchema, Error<ActionCompleteTaskMyNameActionTaskCompletePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_deposit_bank_gold_my_name_action_bank_deposit_gold_post(configuration: &configuration::Configuration, name: &str, deposit_withdraw_gold_schema: models::DepositWithdrawGoldSchema) -> Result<models::BankGoldTransactionResponseSchema, Error<ActionDepositBankGoldMyNameActionBankDepositGoldPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_deposit_bank_item_my_name_action_bank_deposit_item_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: Vec<models::SimpleItemSchema>) -> Result<models::BankItemTransactionResponseSchema, Error<ActionDepositBankItemMyNameActionBankDepositItemPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_simple_item_schema = simple_item_schema;
...
pub async fn action_equip_item_my_name_action_equip_post(configuration: &configuration::Configuration, name: &str, equip_schema: Vec<models::EquipSchema>) -> Result<models::EquipmentResponseSchema, Error<ActionEquipItemMyNameActionEquipPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_fight_my_name_action_fight_post(configuration: &configuration::Configuration, name: &str, fight_request_schema: Option<models::FightRequestSchema>) -> Result<models::CharacterFightResponseSchema, Error<ActionFightMyNameActionFightPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_ge_buy_item_my_name_action_grandexchange_buy_post(configuration: &configuration::Configuration, name: &str, ge_buy_order_schema: models::GeBuyOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeBuyItemMyNameActionGrandexchangeBuyPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_ge_cancel_order_my_name_action_grandexchange_cancel_post(configuration: &configuration::Configuration, name: &str, ge_cancel_order_schema: models::GeCancelOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeCancelOrderMyNameActionGrandexchangeCancelPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActionGeCancelOrderMyNameActionGrandexchangeCancelPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn action_ge_create_buy_order_my_name_action_grandexchange_create_buy_order_post(configuration: &configuration::Configuration, name: &str, ge_buy_order_creation_schema: models::GeBuyOrderCreationSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateBuyOrderMyNameActionGrandexchangeCreateBuyOrderPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_ge_buy_order_creation_schema = ge_buy_order_creation_schema;

    let uri_str = format!("{}/my/{name}/action/grandexchange/create_buy_order", configuration.base_path, name=crate::apis::urlencode(p_path_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_ge_buy_order_creation_schema);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActionGeCreateBuyOrderMyNameActionGrandexchangeCreateBuyOrderPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Create a sell order at the Grand Exchange on the character's map.
pub async fn action_ge_create_sell_order_my_name_action_grandexchange_create_sell_order_post(configuration: &configuration::Configuration, name: &str, ge_order_creation_schema: models::GeOrderCreationSchema) -> Result<models::GeCreateOrderTransactionResponseSchema, Error<ActionGeCreateSellOrderMyNameActionGrandexchangeCreateSellOrderPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_ge_order_creation_schema = ge_order_creation_schema;

    let uri_str = format!("{}/my/{name}/action/grandexchange/create_sell_order", configuration.base_path, name=crate::apis::urlencode(p_path_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_ge_order_creation_schema);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActionGeCreateSellOrderMyNameActionGrandexchangeCreateSellOrderPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn action_ge_fill_my_name_action_grandexchange_fill_post(configuration: &configuration::Configuration, name: &str, ge_fill_buy_order_schema: models::GeFillBuyOrderSchema) -> Result<models::GeTransactionResponseSchema, Error<ActionGeFillMyNameActionGrandexchangeFillPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_ge_fill_buy_order_schema = ge_fill_buy_order_schema;

    let uri_str = format!("{}/my/{name}/action/grandexchange/fill", configuration.base_path, name=crate::apis::urlencode(p_path_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_ge_fill_buy_order_schema);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ActionGeFillMyNameActionGrandexchangeFillPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Give gold to another character in your account on the same map.
pub async fn action_give_gold_my_name_action_give_gold_post(configuration: &configuration::Configuration, name: &str, give_gold_schema: models::GiveGoldSchema) -> Result<models::GiveGoldResponseSchema, Error<ActionGiveGoldMyNameActionGiveGoldPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_give_items_my_name_action_give_item_post(configuration: &configuration::Configuration, name: &str, give_items_schema: models::GiveItemsSchema) -> Result<models::GiveItemResponseSchema, Error<ActionGiveItemsMyNameActionGiveItemPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_npc_buy_item_my_name_action_npc_buy_post(configuration: &configuration::Configuration, name: &str, npc_merchant_buy_schema: models::NpcMerchantBuySchema) -> Result<models::NpcMerchantTransactionResponseSchema, Error<ActionNpcBuyItemMyNameActionNpcBuyPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_npc_sell_item_my_name_action_npc_sell_post(configuration: &configuration::Configuration, name: &str, npc_merchant_buy_schema: models::NpcMerchantBuySchema) -> Result<models::NpcMerchantTransactionResponseSchema, Error<ActionNpcSellItemMyNameActionNpcSellPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_npc_merchant_buy_schema = npc_merchant_buy_schema;
...
pub async fn action_rename_my_name_action_rename_post(configuration: &configuration::Configuration, name: &str, rename_character_schema: models::RenameCharacterSchema) -> Result<models::RenameResponseSchema, Error<ActionRenameMyNameActionRenamePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_rename_character_schema = rename_character_schema;

    let uri_str = format!("{}/my/{name}/action/rename", configuration.base_path, name=crate::apis::urlencode(p_path_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_rename_character_schema);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RenameResponseSchema`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RenameResponseSchema`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ActionRenameMyNameActionRenamePostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Recovers hit points by resting. (1 second per 5 HP, minimum 3 seconds)
pub async fn action_rest_my_name_action_rest_post(configuration: &configuration::Configuration, name: &str) -> Result<models::CharacterRestResponseSchema, Error<ActionRestMyNameActionRestPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_task_cancel_my_name_action_task_cancel_post(configuration: &configuration::Configuration, name: &str) -> Result<models::TaskCancelledResponseSchema, Error<ActionTaskCancelMyNameActionTaskCancelPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_task_exchange_my_name_action_task_exchange_post(configuration: &configuration::Configuration, name: &str) -> Result<models::RewardDataResponseSchema, Error<ActionTaskExchangeMyNameActionTaskExchangePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_task_trade_my_name_action_task_trade_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: models::SimpleItemSchema) -> Result<models::TaskTradeResponseSchema, Error<ActionTaskTradeMyNameActionTaskTradePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_simple_item_schema = simple_item_schema;
...
pub async fn action_transition_my_name_action_transition_post(configuration: &configuration::Configuration, name: &str) -> Result<models::CharacterTransitionResponseSchema, Error<ActionTransitionMyNameActionTransitionPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_unequip_item_my_name_action_unequip_post(configuration: &configuration::Configuration, name: &str, unequip_schema: Vec<models::UnequipSchema>) -> Result<models::EquipmentResponseSchema, Error<ActionUnequipItemMyNameActionUnequipPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
...
pub async fn action_use_item_my_name_action_use_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: models::SimpleItemSchema) -> Result<models::UseItemResponseSchema, Error<ActionUseItemMyNameActionUsePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_simple_item_schema = simple_item_schema;
...
pub async fn action_withdraw_bank_gold_my_name_action_bank_withdraw_gold_post(configuration: &configuration::Configuration, name: &str, deposit_withdraw_gold_schema: models::DepositWithdrawGoldSchema) -> Result<models::BankGoldTransactionResponseSchema, Error<ActionWithdrawBankGoldMyNameActionBankWithdrawGoldPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_deposit_withdraw_gold_schema = deposit_withdraw_gold_schema;
...
pub async fn action_withdraw_bank_item_my_name_action_bank_withdraw_item_post(configuration: &configuration::Configuration, name: &str, simple_item_schema: Vec<models::SimpleItemSchema>) -> Result<models::BankItemTransactionResponseSchema, Error<ActionWithdrawBankItemMyNameActionBankWithdrawItemPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_body_simple_item_schema = simple_item_schema;
...
pub async fn get_all_characters_logs_my_logs_get(configuration: &configuration::Configuration, page: Option<u32>, size: Option<u32>) -> Result<models::DataPageLogSchema, Error<GetAllCharactersLogsMyLogsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_character_logs_my_logs_name_get(configuration: &configuration::Configuration, name: &str, page: Option<u32>, size: Option<u32>) -> Result<models::DataPageLogSchema, Error<GetCharacterLogsMyLogsNameGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_page = page;
    let p_query_size = size;
