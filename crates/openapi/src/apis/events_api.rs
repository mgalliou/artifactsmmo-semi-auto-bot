...
pub fn get_all_active_events_events_active_get(configuration: &configuration::Configuration, page: Option<u32>, size: Option<u32>) -> Result<models::StaticDataPageActiveEventSchema, Error<GetAllActiveEventsEventsActiveGetError>> {
...
pub fn get_all_events_events_get(configuration: &configuration::Configuration, r#type: Option<models::MapContentType>, page: Option<u32>, size: Option<u32>) -> Result<models::StaticDataPageEventSchema, Error<GetAllEventsEventsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
