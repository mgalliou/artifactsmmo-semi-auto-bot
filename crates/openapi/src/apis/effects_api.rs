...
pub fn get_all_effects_effects_get(configuration: &configuration::Configuration, page: Option<u32>, size: Option<u32>) -> Result<models::StaticDataPageEffectSchema, Error<GetAllEffectsEffectsGetError>> {
